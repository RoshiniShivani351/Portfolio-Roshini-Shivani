          ...
          <div className="bg-brand-card rounded-2xl p-8 border border-brand-border shadow-xl">
            <p className="text-lg text-brand-text leading-relaxed">
             ...
             My passion lies in developing scalable systems, writing clean code, and continuously learning new technologies 
              that enhance user experience. From designing RESTful APIs to building responsive interfaces, I’m dedicated to 
              creating efficient, maintainable, and impactful software that makes a difference.
            </p>
          </div>
        </div>
      </section>
